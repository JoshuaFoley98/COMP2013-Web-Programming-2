...
const listing1 = {...listing0, isSold, currentOwner};
 ...
 */
//WRITE YOUR CODE BELOW
console.log(`this house at ${listing1.address} is owned by ${currentOwner}` )
/**
...
const realtorFees = (listing) => {
  let calc = parseInt(listing.price.replace("$","").replace("," , ""))
  console.log(calc)

  return calc <= 450000 ? (calc * 0.025) : (calc * 0.02) 
  
}
console.log(listings[2].price)
